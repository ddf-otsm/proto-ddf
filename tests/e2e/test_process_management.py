...
class TestAutoStart:
    ...
    def test_open_app_preview_button_auto_starts(self, page: Page):
        ...
        page.get_by_placeholder("Describe what you want to build").fill(
            "Test auto-start on preview"
        )
...
class TestHealthDashboard:
    ...
    def test_health_badges_show_app_status(self, page: Page):
        ...
        for i in range(badge_count):
            ...
            assert (
                "up" in badge_text.lower() or "down" in badge_text.lower()
            ), "Badge should show status"
