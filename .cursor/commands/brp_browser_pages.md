...
**Required for**: UI/web repository PRs that affect front-end behavior (see `standards/planning_docs_ci_standards.md`).

Backlinks:

- `guides/tools/browser/browser_pages_visual_journey.md` — detailed guide on when and how to use this command
- `standards/planning_docs_ci_standards.md` — PR checklist requirement
...
- For UI/web repos, this command is **required** before merging PRs that affect front-end behavior (see `standards/planning_docs_ci_standards.md`).
